...
public class AddEditHmoBB {
    ...
    public String setDependentCondition(String hmoOption) {
        System.out.println("Step2--> set dependent condition");
        String path = "";
        ...
        if (valueChangeEvent.getNewValue().toString() != null) {
            ...
            if (checkChildAge(depDob, depType)) {
                ...
                if (list != null) {
                    ...
                    System.out.println("indise list -----------------------------"+p_amount);
                    if (p_amount > 0) {
                        System.out.println("indise p_amount -----------------------------"  +p_amount);
...
//            if (h > 1 || i > 0) {
    ...
    public String onNextHdr() {
        System.out.println("step1-->OnClickNext");
        ViewObject hdrVo = ADFUtils.findIterator("XxhrHmoTrxHdr_EOViewIterator").getViewObject();
        ...
        if ("".equals(photo)) {
            JSFUtils.addFacesErrorMessage("Please upload the image to proceed");
            return "";
        } else {
    ...
    public void setEmployeeHMOCost() {
        System.out.println("step3--> setEmployeeHMOCost");
        ...
        if (!"AXAMANSARD HEALTH".equals(hmo_type) || !"RELIANCE HEALTH".equals(hmo_type) ||
            ...
            System.out.println("Step4--> Get HMO Cost");
            OperationBinding op = com.view
                                     .utils
                                     .ADFUtils
                                     .findOperation("getEmpHmoCost");
            System.out.println("step6--> emp_hmo_cost Package return");
        ...
        // To get Employee Age
        System.out.println("step7--> getEmpAgeCategory");
        OperationBinding op = com.view
                                 .utils
                                 .ADFUtils
        ...
        op.getParamsMap().put("p_hmo_type", hmo_type);
        op.getParamsMap().put("p_emp_dob", dob);
        System.out.println("step9--> EmpAgeCategory package return");
    ...
    public void copyDepDetails(ActionEvent actionEvent) {
        System.out.println("onClickCopyDependence");
    ...
    public Boolean getMaxlimit(){
           ...
           System.out.println("Username value is ---" + userName);
            ...
            System.out.println("Get Query ---" + limitVo.getQuery());
            System.out.println(" limitVo---getEstimatedRowCount  ----" + limitVo.getEstimatedRowCount());
