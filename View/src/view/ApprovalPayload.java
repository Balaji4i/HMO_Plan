...
public class ApprovalPayload {
    ...
    public static final String DUTY_ALLOWANCE_WSDL = "http://oaosoatest-wls-1.sub08071802371.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/ExtraDutyAllowanceApproval/allowanceapprovalprocess_client_ep?WSDL";
  ...
  /***Cloud purpose un comment these section while deploying to TEST cloud **/ 
     public static final String HMO_SUBMIT_WSDL = "http://oaosoatst-wls-1.sub08071802371.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/HMO_Notifications/hmo_bpel_client_ep?WSDL";
 
    /***Cloud purpose un comment these section while deploying to PROD cloud **/  
    
   // public static final String HMO_SUBMIT_WSDL = "http://oaosoaprd-wls-1.sub08071802370.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/HMO_Notifications/hmo_bpel_client_ep?WSDL";
 ...
 //MEDICAL CHANGES     
  ...
  /***Cloud purpose un comment these section while deploying to PROD cloud **/      
    //    public static final String MEDICAL_CHANGE_WSDL = "http://oaosoaprd-wls-1.sub08071802370.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/HMO_Maintenance/hmo_bpel_client_ep?WSDL";
  ...
  /***Cloud purpose un comment these section while deploying to PROD cloud **/      
   //    public static final String REIMBURSEMENT_WSDL = "http://oaosoaprd-wls-1.sub08071802370.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/HMO_Reimbursement/hmo_Reimbursement_bpel_client_ep?WSDL";
  ...
  /***Cloud purpose un comment these section while deploying to PROD cloud **/      
   //    public static final String CARD_CHANGE_WSDL = "http://oaosoaprd-wls-1.sub08071802370.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/HMO_CARD/hmo_card_bpel_client_ep?WSDL";
  ...
  /***Cloud purpose un comment these section while deploying to PROD cloud **/      
     //   public static final String COMPLAINT_WSDL = "http://oaosoaprd-wls-1.sub08071802370.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/HMO_Compliant/hmo_compliant_bpel_client_ep?WSDL";
  ...
  /***Cloud purpose un comment these section while deploying to PROD cloud **/      
     //   public static final String NEW_DEPENDENT_WSDL = "http://oaosoaprd-wls-1.sub08071802370.oandopaasvcn.oraclevcn.com:9073/soa-infra/services/default/HMO_NewDependency/hmo_newdependence_bpel_client_ep?WSDL";
   
 
   
   
    public static final String HMO_SUBMIT_METHOD = "process";
...
String	p_ReqNo,String p_ReqDate,String p_PersonId,String p_Title,
String p_FName,String p_LName,String p_Entity,String p_DepName,
String p_Gender,String p_AlternateEmail,String p_ResiAddress,String p_PlanName,
String p_HmoOption,String p_Category,String p_DependentOption,String p_StateOfRes,
String p_Hospital,String p_ApprovalStatus ,String p_ApprovalComments,String p_HMOPlanTotal,String p_HMOPlanDeduction)
                                              {
        ...
        String xmlData="<soapenv:Envelope xmlns:hmo=\"http://xmlns.oracle.com/HMO_Application/HMO_Notifications/HMO_BPEL\" xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\">\n" + 
        "   <soapenv:Header/>\n" +  
        "   <soapenv:Body>\n" + 
"<hmo:process>\n" +
"        <hmo:RequestNo>"+p_ReqNo+"</hmo:RequestNo>\n" +
"        <hmo:Request_Date>"+p_ReqDate+"</hmo:Request_Date>\n" +
"        <hmo:EmployeeNo>"+p_EmployeeNumber+"</hmo:EmployeeNo>\n" +
"        <hmo:EmployeeName>"+p_EmployeeName+"</hmo:EmployeeName>\n" +
"        <hmo:EmailAddress>"+p_Email+"</hmo:EmailAddress>\n" +
"        <hmo:BusinessGroup>"+p_BusinessGroup+"</hmo:BusinessGroup>\n" +
"        <hmo:ApprovalStatus>"+p_ApprovalStatus+"</hmo:ApprovalStatus> \n" +
"        <hmo:ApprovalComments>"+p_ApprovalComments+"</hmo:ApprovalComments> \n" +
"	 <hmo:PersonId>"+p_PersonId+"</hmo:PersonId> \n" +
"        <hmo:Title>"+p_Title+"</hmo:Title>\n" +
"	 <hmo:FirstName>"+p_FName+"</hmo:FirstName>\n" +
"	 <hmo:LastName>"+p_LName+"</hmo:LastName>\n" +
"        <hmo:DepartmentName>"+p_DepName+"</hmo:DepartmentName>\n" +
"	 <hmo:Entity>"+p_Entity+"</hmo:Entity>\n" +
"	 <hmo:Gender>"+p_Gender+"</hmo:Gender>\n" +
"	 <hmo:AlternateEmail>"+p_AlternateEmail+"</hmo:AlternateEmail>\n" +
"        <hmo:ResidentialAddress>"+p_ResiAddress+"</hmo:ResidentialAddress>\n" +
"        <hmo:PlanName>"+p_PlanName+"</hmo:PlanName>\n" +
"        <hmo:HMOOption>"+p_HmoOption+"</hmo:HMOOption>\n" +
"	<hmo:Category>"+p_Category+"</hmo:Category>\n" +
"	<hmo:DependentOption>"+p_DependentOption+"</hmo:DependentOption>\n" +
"	 <hmo:StateOfResidence>"+p_StateOfRes+"</hmo:StateOfResidence>\n" +
"	<hmo:Hospital>"+p_Hospital+"</hmo:Hospital>\n" +
        "       <hmo:HMOPlanTotal>"+p_HMOPlanTotal+"</hmo:HMOPlanTotal>\n" +
        "       <hmo:HMOPlanDeduction>"+p_HMOPlanDeduction+"</hmo:HMOPlanDeduction>\n" +
"</hmo:process> \n" +
        "   </soapenv:Body>\n" + 
        "   </soapenv:Envelope>";
        return xmlData;
